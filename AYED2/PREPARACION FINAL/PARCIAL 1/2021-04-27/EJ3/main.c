...
int main(int argc, char *argv[])
{
    ...
    printf("El arreglo %s.\n", array_is_sorted(playlist, length) ? "esta ordenado" : "no esta ordenado");

    /* check if it is odd-sorted and show message */
    printf("El arreglo %s.\n", array_is_odd_sorted(playlist, length) ? "esta imparmente ordenado" : "no esta imparmente ordenado");
